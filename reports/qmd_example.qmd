...
author: "Tiffany Timbers, Jordan Bourak & Eugene Tse"
format:
  html:
    toc: true
    toc-depth: 3
    code-links:
      - text: Published Report
        ...
        href: https://gene-008.github.io/assignment3-Python/reports/qmd_example.html
      - text: GitHub Repo
        icon: github
        href: https://github.com/Gene-008/assignment3-Python
  pdf:
    toc: true
    toc-depth: 3
execute:
...
* [GitHub Repository](https://github.com/Gene-008/assignment3-Python)
* [Published HTML Report](https://gene-008.github.io/assignment3-Python/reports/qmd_example.html) <br>
...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-horse-pops width=100%}
